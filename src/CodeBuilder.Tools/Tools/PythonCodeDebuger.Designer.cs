...
{
    partial class PythonCodeDebuger
    {
        /// <summary> 
        /// 必需的设计器变量。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.txtCode.Text = "\'\'\'\r\n默认定义了main函数，因此可以直接写代码；如果需要定义其他函数，需要定义main函数，如：\r\ndef add():\r\n    return 1+2+3" +
    "+4\r\n\r\ndef main():\r\n    return add()\r\n\'\'\'\r\n\r\nprint(\"hello world\")\r\nreturn 55*2+45" +
    "";
            // 
            // btnSave
            ...
            this.btnSave.Location = new System.Drawing.Point(579, 308);
            ...
            this.btnOpen.Location = new System.Drawing.Point(493, 308);

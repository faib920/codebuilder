...
namespace CodeBuilder.Core.Template
{
    ...
    public class PartitionWriter
    {
        ...
        public static void Write(GeneratePartitionResult result, object schema, object profile, string output, bool overFile)
        {
            var fileName = Parser.PreParse(schema, profile, result.Partition.Output);
            ...
            Util.TryOperateFile(path,() => File.WriteAllText(path, result.Content, StaticUnity.Encoding));

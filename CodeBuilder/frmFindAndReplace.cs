...
namespace CodeBuilder
{
    public partial class frmFindAndReplace : Form
    {
        ...
        public frmFindAndReplace(IDevHosting hosting)
        {
            InitializeComponent();
        ...
        public TextRange FindNext(bool viaF3, bool searchBackward, string messageIfNotFound)
        {
            ...
            {
                _hosting.ShowWarn(messageIfNotFound);
            }
        ...
        private void btnReplaceAll_Click(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                _hosting.ShowWarn("没有单词被替换。");
            }
            else
            {
                _hosting.ShowWarn(string.Format("替换了 {0} 处单词。", count));
                Close();
            }
        }
